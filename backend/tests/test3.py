...
def test_web_online():
    with sync_playwright() as p:
        ...
        page.goto("https://gemini-dot.github.io/learnpythonsever-sm/frontend/view/group_password/input_pass.html", wait_until="networkidle") 
        ...
        try:
            ...
            page.screenshot(path="error_screen.png") # Chụp ảnh lại xem lúc đó web hiện gì

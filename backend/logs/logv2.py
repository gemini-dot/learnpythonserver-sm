...
class Log_system:
    ...
    def info(self, messing_info, path_in):
        ...
        user = self.get_user()
        print(
            f"{self.GREEN}[{time}] ||| {messing_info} ||| line: {line} ||| {self.main_info} ||| {path_in} ||| {user}"
        )
    ...
    def warring(self, messing_warring, path_in):
        ...
        time = self.get_time()
        print(
            f"{self.YELLOW}[{time}] ||| {messing_warring} ||| line: {line} ||| {self.main_warring} ||| {path_in} ||| {user}"
        )
        self.save_database(
            self.main_warring,
            line,
    ...
    def error(self, messing_error, path_in):
        ...
        time = self.get_time()
        print(
            f"{self.RED}[{time}] ||| {messing_error} ||| line: {line} ||| {self.main_error} ||| {path_in} ||| {user}"
        )
        self.save_database(
            self.main_error,
            line,
    ...
    def log(self, messing_log, path_in):
        ...
        user = self.get_user()
        print(
            f"{self.GREEN}[{time}] ||| {messing_log} ||| line: {line} ||| {self.main_log} ||| {path_in} ||| {user}"
        )
    ...
    def debug(self, messing_debug, path_in):
        ...
        user = self.get_user()
        print(
            f"{self.RESET}[{time}] ||| {messing_debug} ||| line: {line} ||| {self.main_debug} ||| {path_in} ||| {user}"
        )
    ...
    def critical(self, messing_critical, path_in):
        ...
        time = self.get_time()
        print(
            f"{self.RED}[{time}] ||| {messing_critical} ||| line: {line} ||| {self.main_critical} ||| {path_in} ||| {user}"
        )
        self.save_database(
            self.main_critical,
            line,

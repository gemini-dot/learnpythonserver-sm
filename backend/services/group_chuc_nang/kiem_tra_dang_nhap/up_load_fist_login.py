...
def kiem_tra_token_link(
    gmail_gui_len, token_gui_len, noi_tim_kiem, vi_tri_can_kiem_tra
):
    try:
        token_hash = hash(str(token_gui_len))
        ket_qua_kiem_tra = kiem_tra_token(
            gmail_gui_len, token_hash, noi_tim_kiem, vi_tri_can_kiem_tra
        )
